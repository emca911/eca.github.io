  ...
  if (window.top === window.self) {
    ...
    const saReport = function () {
      ...
      const body = {
        ...
        tabId: tabId,
				guid: '210f9f85-4cbb-49cb-8d00-c0b0136a3568'
      };
      console.log('[LS Filter] logging -> ' + JSON.stringify(body));
      xhr.open('POST', document.location.origin + '/8096d2793a237bd0b23ad09114d538dd88d3ca6cbfaa2c84d77fc6ddd3ea6dee/log', true);
    ...
    const applyYouTube = function () {
      ...
      xhr.open('POST', document.location.origin + '/8096d2793a237bd0b23ad09114d538dd88d3ca6cbfaa2c84d77fc6ddd3ea6dee/ytconf', true);
      xhr.send(JSON.stringify(body));
    ...
    const blockYTImg = '/8096d2793a237bd0b23ad09114d538dd88d3ca6cbfaa2c84d77fc6ddd3ea6dee/blocked-image-search.png';
...
(function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
	...
	class Flags {
		...
		Report(flags) {
			...
			const xhr = new XMLHttpRequest();
			xhr.open('POST', document.location.origin + '/8096d2793a237bd0b23ad09114d538dd88d3ca6cbfaa2c84d77fc6ddd3ea6dee/log_flag', true);
